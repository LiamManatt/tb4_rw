...
sys.path.append("/home/ubuntu/ros2_ws_5/src/my_robot_controller/my_robot_controller")
...
class odom_data_subscriber_dodge(Node):

    def __init__(self):
        super().__init__("odom_data_subscriber_dodge")
...
def main(args=None):
    ...
    Odom_data_subscriber = odom_data_subscriber_dodge()
